...
void main() {
    int *p; //this variable is a pointer and now can be able to store address of any integer variable
    void *ptr;  //void pointer can store address of any data type variable
    float *fptr = NULL; //this is a pointer variable which is initialized with NULL
    

    // int a = 99;
    // p = &a; //storing address of a in p

    // printf("\nAddress of a = %X\t, p = %x", &a, p);
    // printf("\nValue of a = %d\t, *p = %d", a, *p);

    // //pointer to pointer
    // int **p1 = &p;

    // printf("\nAddress of p = %X\t, p1 = %x", &p, p1);
    // printf("\nValue of p = %X\t, *p1 = %X", p, *p1);
    // printf("\nValue of a = %d\t, **p1 = %d", a, **p1);
    ...
    // ptr = &a;
    // printf("\nAddress of a = %X\t, ptr = %x", &a, ptr);
    // printf("\nValue of a = %d\t, *ptr = %d", a, *(int *)ptr);

    // ptr = &b;
    // printf("\nAddress of b = %X\t, ptr = %x", &b, ptr);
    // printf("\nValue of b = %f\t, *ptr = %f", b, *(float *)ptr);

    // ptr = &c;
    // printf("\nAddress of c = %X\t, ptr = %x", &c, ptr);
    // printf("\nValue of c = %c\t, *ptr = %c", c, *(char *)ptr);


    //null pointer
    printf("\nAddress of fptr = %X\t, fptr = %x", &fptr, fptr);
    printf("\nValue of fptr = %X\t, *fptr = %X", fptr, *fptr);
...
Test Data :
Input a string : Vishwa_with_a_W
Expected Output :

The length of the given string Vishwa_with_a_W                                                                    
is : 10    
...
------------------------------------------------                                                              
 Input a string : Vishwa_with_a_W                                                                                  
 Reverse of the string is : W_a_htiw_awhsiV
